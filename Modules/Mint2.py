...
class Mint:
    ...
    def get_all_keywords(self):
        ...
        cursor = connection.cursor()
        try:
            sql = "SELECT word, priority, piazzaid FROM keywords"  # Query
    ...
    def get_keywords_with_information(self, piazza_id=str):
        ...
        cursor = connection.cursor()
        try:
            sql = "SELECT word, priority, piazzaid FROM keywords WHERE piazzaid = " + piazza_id  # Query
            cursor.execute(sql)  # Executes the query
            result = cursor.fetchall()
    ...
    def get_keyword_with_id(self, index_id=str):
        ...
        cursor = connection.cursor()
        try:
            sql = "SELECT word, priority, piazzaid FROM keywords WHERE idkeywords =" + index_id  # Query
            cursor.execute(sql)  # Executes the query
            result = cursor.fetchall()
